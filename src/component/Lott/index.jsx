...
export const Lott = () => {
  ...
  React.useEffect(() => {
    ...
    lottie.loadAnimation({
      ...
      loop: true,
      autoplay: true,
      // path: dataJ,//如果没有图片做动效,全是设计师用画的矢量图形
      animationData: dataJ   //如果有图片做动效,二者填其一即可
  })
